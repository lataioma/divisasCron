...
/**
 * Servlet implementation class Tigger
 */
@WebServlet("/edit")
public class Tigger extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            out.printf(new Locale("es", "ESP"), "Trabajo re-calendarizado<br>Próxima ejecución:<br>%tc", date);
        } catch (Exception e) {
            out.print("<pre>");
            e.printStackTrace(out);
            out.print("</pre>");
